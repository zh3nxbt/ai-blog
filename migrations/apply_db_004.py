"""Apply db-004 migration using direct PostgreSQL connection."""
...
def read_migration_sql() -> str:
    ...
    migration_path = Path(__file__).parent / "004_create_blog_rss_sources.sql"
...
def main():
    """Apply migration."""
    print("=" * 70)
    print("APPLYING MIGRATION: db-004 - Create blog_rss_sources table")
    print("=" * 70)
    print()
    ...
    try:
        ...
        print("  PYTHONPATH=/workspace/ai-blog python migrations/verify_db_004.py")
        print()
        return 0
