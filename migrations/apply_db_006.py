"""Apply db-006 migration using direct PostgreSQL connection."""
...
def read_migration_sql() -> str:
    ...
    migration_path = Path(__file__).parent / "006_create_database_indexes.sql"
...
def main():
    """Apply migration."""
    print("=" * 70)
    print("APPLYING MIGRATION: db-006 - Create database indexes")
    print("=" * 70)
    print()
    ...
    try:
        ...
        print("  PYTHONPATH=/workspace/ai-blog python migrations/verify_db_006.py")
        print()
        return 0
