"""Apply db-005 migration using direct PostgreSQL connection."""
...
def read_migration_sql() -> str:
    ...
    migration_path = Path(__file__).parent / "005_create_blog_rss_items.sql"
...
def main():
    """Apply migration."""
    print("=" * 70)
    print("APPLYING MIGRATION: db-005 - Create blog_rss_items table")
    print("=" * 70)
    print()
    ...
    try:
        ...
        print("  PYTHONPATH=/workspace/ai-blog python migrations/verify_db_005.py")
        print()
        return 0
