"""Apply db-003 migration using direct PostgreSQL connection."""
...
def read_migration_sql() -> str:
    ...
    migration_path = Path(__file__).parent / "003_create_blog_agent_activity.sql"
...
def main():
    """Apply migration."""
    print("=" * 70)
    print("APPLYING MIGRATION: db-003 - Create blog_agent_activity table")
    print("=" * 70)
    print()
    ...
    try:
        ...
        print("  PYTHONPATH=/workspace/ai-blog python migrations/verify_db_003.py")
        print()
        return 0
